...
const heroCopy = {
  it: {
    ...
    continue: 'Continua',
    beforePortrait: 'Costruisco sistemi AI',
    afterPortrait: <>che diventano <em>prodotti.</em></>,
  ...
  en: {
    ...
    continue: 'Continue',
    beforePortrait: 'I build AI systems',
    afterPortrait: <>that become <em>products.</em></>,
